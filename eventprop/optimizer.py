...
class Adam(Optimizer):
    ...
    def step(self):
        ...
        while ancestor_layer is not None:
            ...
            ancestor_layer._opt_adam_m = self.parameters.beta1 * ancestor_layer._opt_adam_m + (1-self.parameters.beta1) * ancestor_layer.gradient
            ancestor_layer._opt_adam_v = self.parameters.beta2 * ancestor_layer._opt_adam_v + (1-self.parameters.beta2) * ancestor_layer.gradient**2
            ...
            logging.debug(f"Updating weights with delta_w norm {np.linalg.norm(delta_w)}.")
